...
// import { tokyoNightDark } from 'react-syntax-highlighter/dist/esm/styles/prism';
...
const CodeTranslationChatbot = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      <h1 className="text-3xl font-bold mb-8">Code Translator</h1>
      <div className="flex gap-8 flex-wrap justify-center">
        <div className="bg-gray-800 rounded-lg p-4 max-w-md w-full md:w-auto">
          <h2 className="text-xl font-semibold mb-4">Input</h2>
          <form onSubmit={handleSubmit} className="flex flex-col">
        ...
        <div className="bg-gray-800 rounded-lg p-4 max-w-md w-full md:w-auto">
          <h2 className="text-xl font-semibold mb-4">Output</h2>
          <div className="overflow-y-auto max-h-96">
            {/* <SyntaxHighlighter language={targetLanguage.toLowerCase()} style={tokyoNightDark}> */}
